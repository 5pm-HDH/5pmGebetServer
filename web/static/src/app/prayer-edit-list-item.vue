<template>
    <fieldset style="border: 1px solid black; border-radius: 5px; box-shadow: 0 3px 3px rgba(0,0,0,0.2); padding: 4rem;">
        <h3>#{{ id }}</h3>
        ...
        <input class="button-primary" :value="(isEdit ? 'Speichern' : 'Bearbeiten')" v-on:click="clickButton">
    </fieldset>
